            ...
            <div id="footer">
                <div className="inner">
                    <ul className="icons">
                        ...
                        <li><a href="https://linkedin.com/in/sergeichestakov/" className="icon fa-linkedin" target="_blank" rel="noopener noreferrer"><span className="label">LinkedIn</span></a></li>
